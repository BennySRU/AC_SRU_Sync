...
namespace AC_SRU_Skins
{
    public partial class FrmMain : Form
    {
        ...
        {
            if (AC_SRU_Skins.Properties.Settings.Default.DesktopLocationX >= 0 &&
                AC_SRU_Skins.Properties.Settings.Default.DesktopLocationY >= 0)
                this.SetDesktopLocation(AC_SRU_Skins.Properties.Settings.Default.DesktopLocationX, AC_SRU_Skins.Properties.Settings.Default.DesktopLocationY);// = AC_SRU_Sync.Properties.Settings.Default.WindowPosition;
        ...
        {
            txtFTP.Text = AC_SRU_Skins.Properties.Settings.Default.ftpPath;
            txtACEXE.Text = AC_SRU_Skins.Properties.Settings.Default.localPath;
            if (txtACEXE.Text.Equals(""))txtACEXE.Text = ACHelper.getACSFolder() + @"\AssettoCorsa.exe";
            txtFtpUser.Text = AC_SRU_Skins.Properties.Settings.Default.ftpUser;
            pnlSettings.Visible = AC_SRU_Skins.Properties.Settings.Default.SettingsVisible;
            btnShowSettings.Text = pnlSettings.Visible ? "-" : "+";

            if (!AC_SRU_Skins.Properties.Settings.Default.ftpPassword.Equals(""))
            {
                txtFtpPassword.Text = simpleAES.DecryptString(AC_SRU_Skins.Properties.Settings.Default.ftpPassword);
            }
            else
            {
                txtFtpPassword.Text = "";
        ...
        private void CloseApplication()
        {
            ...
            AC_SRU_Skins.Properties.Settings.Default.DesktopLocationX = this.DesktopLocation.X;
            AC_SRU_Skins.Properties.Settings.Default.DesktopLocationY = this.DesktopLocation.Y;
            AC_SRU_Skins.Properties.Settings.Default.SettingsVisible = pnlSettings.Visible;
            AC_SRU_Skins.Properties.Settings.Default.Save();
        ...
        {
            if (txtFTP.Text.Equals(AC_SRU_Skins.Properties.Settings.Default.ftpPath) &&
            txtACEXE.Text.Equals(AC_SRU_Skins.Properties.Settings.Default.localPath) &&
            txtFtpUser.Text.Equals(AC_SRU_Skins.Properties.Settings.Default.ftpUser) &&
            (txtFtpPassword.Text.Equals("") && AC_SRU_Skins.Properties.Settings.Default.ftpPassword.Equals("")) ||
            simpleAES.EncryptToString(txtFtpPassword.Text).Equals(AC_SRU_Skins.Properties.Settings.Default.ftpPassword))
            {
                return false;
            }
            else
        ...
        {
            AC_SRU_Skins.Properties.Settings.Default.ftpPath = txtFTP.Text;
            AC_SRU_Skins.Properties.Settings.Default.localPath = txtACEXE.Text;
            AC_SRU_Skins.Properties.Settings.Default.ftpUser = txtFtpUser.Text;
            if (!txtFtpPassword.Text.Equals(""))
            {
                AC_SRU_Skins.Properties.Settings.Default.ftpPassword = simpleAES.EncryptToString(txtFtpPassword.Text);
            }
            else
            {
                AC_SRU_Skins.Properties.Settings.Default.ftpPassword = "";
            }
            AC_SRU_Skins.Properties.Settings.Default.Save();
        }
        ...
        //{
        //    string mainDir = AC_SRU_Skins.Properties.Settings.Default.MainDirectories;
        //    string toSync = AC_SRU_Skins.Properties.Settings.Default.ToSync;
        ...
        //            {
        //                if (AC_SRU_Skins.Properties.Settings.Default.ToSync.Contains(mainDir.ftpDir.GetSeriesName()) && mainDir.ftpFilesToSync.Count > 0)
        //                {
